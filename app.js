        ...
        try {
            ...
            if (data) {
                ...
                const knowledgeGroundingDirective = [
                    ...
                    'then narrate. This is a documented user preference — visuals are more',
                    'digestible than long prose for these shapes.',
                    '',
                    'MANDATORY trigger for render_chart (bar for categories, line for time):',
                    '- User asks about their scores/results across multiple dimensions.',
                    '- Discussing quiz sub-scores, EI facets, personality traits, values distribution.',
                    '- Any answer where you would naturally say "you scored X on A, Y on B, Z on C".',
                    '- Progress/change over time (frequency of an activity, engagement trend).',
                    '- Ranking/weighting several items numerically.',
                    '',
                    'MANDATORY trigger for render_table:',
                    '- Comparing 2–5 items across the same 2–4 attributes (frameworks, options,',
                    '  choices, coaches, quizzes).',
                    '- Any answer where you would naturally say "here are the differences between',
                    '  A and B in terms of X and Y".',
                    '- Presenting a small side-by-side of pros/cons or approach-by-focus.',
                    '',
                    'AFTER RENDERING:',
                    '- Speak/type only a brief 1–2 sentence framing of what the visual shows and',
                    '  why it matters. Do NOT read the chart values or table cells aloud line by',
                    '  line — the user sees them. Point out the pattern, not the data.',
                    '',
                    'AVOID:',
                    '- Single numbers ("your score is 78" needs no chart).',
