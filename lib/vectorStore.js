...
async function suggestFollowUps({ messages = [], persona = '', activity = null, model } = {}) {
    ...
    const systemPrompt = [
        ...
        'Produce EXACTLY 2 short messages the USER might send.',
        '',
        'Rules:',
        ...
        '- Each item: 3-6 words, punchy and casual — not a full formal question. No trailing punctuation except a question mark.',
        isStarter
        ...
        // hedgy ("maybe I should stop"). Forward-moving intents keep energy
        // and give the user a real choice of angles.
        '- Provide TWO forward-moving intents: (a) one concrete next-step ("How would I…", "What would I try first"), (b) one deeper reflection ("What\'s underneath this", "Why does that matter to me").',
        ...
        '',
        'Return ONLY a JSON array of 2 strings. No code fences, no prose.'
    ].filter(Boolean).join('\n');
