 ...
 */
async function suggestFollowUps({ messages = [], persona = '', model } = {}) {
    ...
    const systemPrompt = [
        'You suggest what a person in coaching might ASK NEXT.',
        'You will see the recent turn(s). Produce EXACTLY 3 short follow-up messages the USER might send.',
        '',
        'Rules:',
        ...
        '- Highly relevant to what the coach just said or asked.',
