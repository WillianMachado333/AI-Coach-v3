...
// after the fact that they were looking at two different deploys. Read once
// at process start (git metadata doesn't change while the process runs) and
// cached; falls back to 'dev' if there's no .git (e.g. a slim Docker layer).
