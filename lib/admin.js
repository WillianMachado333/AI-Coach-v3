...
<script>
  (function () {
    ...
    // Parse fenced ```chart / ```table blocks from a done text and render
    // them inline. Caps: 3 charts + 3 tables per answer.
        ...
        while (true) {
          ...
          while ((idx = buf.indexOf('\n\n')) !== -1) {
            ...
            if (evt.type === 'task') bumpTask(evt);
              ...
              // After streaming finishes, extract fenced ```chart / ```table
              // blocks and render them inline, stripping them from the prose.
