...
<style>
  * { box-sizing: border-box; }
  body { margin:0; font-family:-apple-system,BlinkMacSystemFont,"Inter",sans-serif;
    min-height:100vh; display:flex; background:#f4f7f9; color:#0b1a24; }
  ...
  .hero { position:relative; overflow:hidden; flex:none;
    ...
    color:#dbe6eb; padding:40px 36px; display:flex; flex-direction:column; justify-content:space-between; }
  @media (min-width: 900px) { .hero { width:46%; min-height:100vh; } }
  @media (max-width: 899px) { .hero { padding:28px 24px 34px; } }
  ...
  .hero-brand svg { width:30px; height:30px; }
  .hero-brand span { font-weight:600; font-size:16px; letter-spacing:-.01em; color:#f0f6fa; }
  .hero-copy h1 { font-size:26px; line-height:1.3; margin:0 0 10px; font-weight:600; color:#f0f6fa; letter-spacing:-.01em; }
  @media (min-width: 900px) { .hero-copy h1 { font-size:32px; } }
  .hero-copy p { font-size:14px; line-height:1.6; color:#8fa6b1; margin:0; max-width:38ch; }
  ...
  <div class="hero">
    <div class="hero-brand">
      <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs><linearGradient id="hlg" x1="18" y1="104" x2="102" y2="20" gradientUnits="userSpaceOnUse">
          <stop offset="0" stop-color="#087F79"/><stop offset=".55" stop-color="#10A7B0"/><stop offset="1" stop-color="#32C5E5"/>
        </linearGradient></defs>
        <path d="M91 27C82 20 71 16 59 16 32.5 16 11 37.5 11 64s21.5 48 48 48c12 0 23-4.4 31.5-11.7L76.8 84.7A27.2 27.2 0 0 1 59 91.3 27.3 27.3 0 1 1 76.6 43.8L91 27Z" fill="url(#hlg)"/>
    ...
    <div class="hero-copy">
      <h1>Design, test, and observe your AI coach.</h1>
      <p>The admin surface for Erica — personas, live simulation, and session observability for the Talent Transformation team.</p>
    </div>
    <div></div>
  </div>
