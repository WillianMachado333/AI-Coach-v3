...
function renderCoachIdentityCard(budget, { coursesCount, quizzesCount, frameworksCount }) {
    ...
    <div class="ci-hero">
      <div class="ci-hero-title">
        ...
        <span class="ci-persona-tag"><a href="/admin/frameworks/${encodeURIComponent(persona)}">${escapeHtml(persona)}</a></span>
      ...
      <div class="ci-grid">
        ...
        <div>
          ...
          <div class="ci-actions">
            ...
            <a href="/admin/frameworks/${encodeURIComponent(persona)}">Edit persona →</a>
          </div>
        </div>
      </div>
    </div>`;
