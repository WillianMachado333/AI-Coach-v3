# Stability Biases — semantic guide

> Find out if your comfort zone is holding you back and learn to embrace change with confidence in 2 minutes.

_Below is the marketing/landing content of this quiz on the Talent Transformation site — the same semantic framing users see. Coach may echo it when explaining or introducing the quiz. Edit / polish as needed. Never add URLs, exact question wording, or scoring here — those are hard data and reach Erica via preparation._

## What the site says about this quiz

Do you often find yourself avoiding conflict? Social bias is a cognitive bias that arises due to a human inclination toward preferring harmony over conflict. This free quiz helps you understand how social biases may influence your thoughts and actions. Take this free quiz now and receive your free personalized report detailing the social biases that impact you most and how you can manage them.
...
Conflict can be uncomfortable, and people naturally tend towards harmony. Nevertheless, it's essential to recognize how our social biases may cause us to shy away from difficult conversations or situations that require direct action. By taking the Free Social Biases, you can explore what underlying beliefs might influence your decisions - empowering you with knowledge so you are better equipped for any challenge!
...
Each quiz provides a customized report which links a workbook and helpful reading materials to learn more about cognitive biases.
...
_Optional refinement: distill the above into a one-sentence competency the quiz surfaces._

## What it does NOT try to do

- _Fill in common misreadings — e.g. "this is not a diagnostic tool", "this does not measure X"._

## When Erica should reference this quiz

- _Fill in: what the learner might be asking or feeling when this quiz is the right suggestion._
